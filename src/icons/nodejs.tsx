    ...
    >
      <g clipPath="url(#clip0_337_7900)">
        ...
        <g
          ...
          <path
            d="M108.31 40.901a3.367 3.367 0 0 0-3.332 0L77.476 56.778c-1.045.589-1.633 1.7-1.633 2.875v31.82c0 1.176.653 2.287 1.633 2.875l27.502 15.877a3.367 3.367 0 0 0 3.332 0l27.502-15.877c1.045-.588 1.633-1.7 1.633-2.875v-31.82a3.406 3.406 0 0 0-1.633-2.874L108.31 40.9Z"
            fill="url(#paint0_linear_337_7900)"
          >
          </path>
          <path
            d="M135.877 56.779 108.244 40.9a4.543 4.543 0 0 0-.849-.326L76.5 93.5c.261.327.673.804 1 1l27.478 15.725c.784.457 1.698.588 2.548.326l29.069-53.184a2.044 2.044 0 0 0-.718-.588Z" fill="url(#paint1_linear_337_7900)"></path><path d="m104.063 35.086-.392.196h.523l-.131-.196Z"
              fill="url(#paint2_linear_337_7900)"
            >
          </path>
          <path
            d="M135.809 94.348c.784-.458 1.491-1.315 1.491-2.348l-30.104-51.49c-.784-.131-1.633-.066-2.352.391L77.408 56.713 107 110.682a4.54 4.54 0 0 0 1.241-.392l27.568-15.942Z"
            fill="url(#paint3_linear_337_7900)"
          >
          </path>
        </g>
      </g>
      <defs>
        ...
        <linearGradient
          id="paint3_linear_337_7900" x1="74.835" y1="75.553" x2="138.473" y2="75.553"
          gradientUnits="userSpaceOnUse">
          <stop
            offset=".092"
            stopColor="#6ABF4B">
